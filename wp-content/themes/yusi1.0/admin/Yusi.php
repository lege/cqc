...
<div class="wrap d_wrap">
    ...
    <h2><?php echo $themename; ?>设置
        <span class="d_themedesc">发布来源：<a href="http://www.yusi123.com/" target="_blank">欲思博客</a> &nbsp;&nbsp; <a href="http://yusi123.com/3233.html" target="_blank">访问<?php echo $themename; ?>主页</a></span><span style="font-size:16px;color: rgb(245, 99, 99);padding-left:20px;">觉得主题不错？支持一下我继续更新吧 -><a href="http://yusi123.com/pay" target="_blank">捐赠</a></span>
    </h2>
