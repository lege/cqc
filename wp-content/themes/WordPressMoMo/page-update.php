...
<link rel="shortcut icon" href="http://www.wpmomo.com/wp-content/themes/WordPressMoMo/favicon.ico" type="image/x-icon" />
...
.browser .new{background:url(http://cdn.dmeng.net/images/new.png);width:23px;height:9px;display:inline-block;}
...
<p>你正在使用 Internet Explorer 的过期版本（IE6、IE7或使用该内核的浏览器）。这意味着在升级浏览器前，你将无法访问此网站。</p>
