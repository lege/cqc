...
?>
<li><a href="<?php the_permalink(); ?>"><?php if( $img ){echo '<div class="huilang_fl1">'; echo deel_thumbnail(); echo '</div>'; }else{$img = '';} ?><div class="huilang_fl2"><span class="text"><?php the_title(); ?></span><span class="muted"><?php the_time('Y-m-d');?></span><span class="muted"><?php comments_number('', '%评论'); ?></span></div></a></li>
<?php
